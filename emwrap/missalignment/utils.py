...
# TODO: We don't need this anymore however it can be useful to have as a utils for Warp XML parsing. We can move it to a utils module if we want to keep it.
